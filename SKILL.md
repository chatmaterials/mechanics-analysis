...
- screen elastic stability heuristics and ductility descriptors
...
- `scripts/analyze_elastic_tensor.py`
  Summarize a 6x6 elastic tensor, estimate Voigt/Reuss/Hill moduli, and report a stability heuristic.
