...
Standalone skill for mechanics-relevant DFT result analysis, including elastic-stability heuristics, anisotropy/hardness descriptors, and multi-candidate screening.
...
python3 scripts/compare_mechanical_candidates.py fixtures fixtures/candidates/soft fixtures/candidates/hard-brittle --bulk-min 120 --bulk-max 180 --json
